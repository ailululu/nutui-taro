...
*/
import { reactive, computed, toRefs, resolveComponent, openBlock, createElementBlock, normalizeStyle, renderSlot, createCommentVNode, createElementVNode, withDirectives, createVNode, vShow } from "vue";
...
const _hoisted_5 = ["type", "maxlength", "placeholder", "value"];
const _hoisted_6 = {
  key: 1,
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("view", {
    ...
    createElementVNode("view", {
      ...
      _ctx.$slots.rightin ? (openBlock(), createElementBlock("view", _hoisted_6, [
        renderSlot(_ctx.$slots, "rightin")
      ])) : createCommentVNode("", true)
    ], 4),
    _ctx.$slots.rightout ? (openBlock(), createElementBlock("view", _hoisted_7, [
